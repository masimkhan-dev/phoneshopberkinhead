...
export function AnnouncementTicker() {
  ...
  const tickerItem = (
    <div className="flex items-center gap-3 whitespace-nowrap px-4">
      ...
      <span className="text-[#F4EFEA]">Visit us in Birkenhead</span>
      <span className="text-[#888179]">•</span>
      <a
        href={whatsappUrl}
        target="_blank"
        rel="noreferrer"
        className="group inline-flex items-center gap-1 font-bold text-[#AC313F] transition-colors hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#AC313F]"
      >
  ...
  return (
    <div
      ...
      className="ticker-root relative z-50 h-[34px] w-full overflow-hidden bg-[#171717] text-[12px] sm:text-[13px] font-medium text-white/95 border-b border-white/10 sm:h-[36px] flex items-center select-none"
    >
      ...
      <div className="ticker-static container-page flex w-full items-center justify-center text-center truncate !px-2">
        <div className="flex items-center gap-2 truncate">
          <span className="truncate text-white">
            Device broken? Express repairs for phones, laptops, tablets &amp; gaming consoles in Birkenhead
          </span>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group inline-flex shrink-0 items-center gap-1 font-bold text-[#AC313F] hover:text-white"
          >
