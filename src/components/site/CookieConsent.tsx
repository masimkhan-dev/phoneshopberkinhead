  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3 mb-2">
        <div className="flex items-center gap-2 text-[#AC313F] font-extrabold text-sm tracking-wide">
          <ShieldCheck className="w-4 h-4 shrink-0 text-[#AC313F]" />
          <span>Privacy & Cookie Preferences</span>
        </div>
        <button
          onClick={() => handleAccept("essential")}
          className="grid h-11 w-11 shrink-0 place-items-center rounded-lg text-white/60 transition-colors hover:bg-white/10 hover:text-white"
      ...
      <p className="mb-4 text-sm leading-relaxed text-white/80">
        ...
        <Link to="/cookies" className="font-semibold text-[#AB5163] hover:underline">
          Cookie Policy
        </Link>
        .
      </p>
