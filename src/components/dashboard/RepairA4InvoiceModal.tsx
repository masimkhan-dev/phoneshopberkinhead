              ...
              return (
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 text-[9px] sm:text-[9.5px] leading-snug text-slate-700 space-y-1.5">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Thank you for choosing {identity.name}. We appreciate your business and hope you are completely satisfied with your repair.
                  </p>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Thank you for choosing {identity.name}. We&apos;re always happy to help.
                  </p>
            ...
            <div className="pt-2 border-t border-slate-200 flex flex-row items-center justify-between gap-4">
              ...
              <div className="text-left text-[10px] text-slate-700 font-medium space-y-1">
                <p className="leading-snug">
                  {SITE_URL ? "For full Repair Terms, Warranty & Refund Policy, visit:" : "Ask in store for full Repair Terms, Warranty & Refund Policy."}
                </p>
