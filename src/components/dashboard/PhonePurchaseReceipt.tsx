...
const sellerPurchaseTerms = (businessName: string) => [
  {
    title: "1. Ownership",
  ...
  },
  {
    ...
    text: `I confirm that I have backed up any information I wish to keep and have removed or disclosed applicable Apple, Google, Samsung or other account/activation locks. I authorise ${businessName} to test, erase and factory-reset the device where necessary.`,
  },
  {
    title: "6. Age Confirmation",
    text: `I confirm that I am aged 18 or over in accordance with ${businessName}'s store purchasing policy.`,
  },
  {
          ...
          <div className="bg-white border-0 shadow-none p-4 rounded-none max-w-2xl mx-auto space-y-2.5 text-slate-900 font-sans a4-sheet-page">
            ...
            <div className="flex justify-between items-center pb-2 border-b-2 border-slate-900 gap-2">
              <div className="space-y-0.5">
                ...
                <p className="text-[9.5px] text-slate-600 font-mono leading-tight">
                  Tel: {businessPhone}{businessEmail && ` | ${businessEmail}`}</p>
              </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-2 text-[9px] leading-tight text-slate-800 space-y-0.5">
              ...
              <div className="grid grid-cols-1 gap-0.5 pt-0.5">
                {sellerPurchaseTerms(businessName).map((pt) => (
              ...
              <p className="text-[8.5px] text-slate-600 pt-1 leading-tight border-t border-slate-200 mt-1">
                <strong>Privacy Notice:</strong> Seller information collected for this transaction will be processed in accordance with {businessName}'s Privacy Policy. Relevant information may be disclosed to law-enforcement or other authorities where there is an appropriate lawful basis or legal requirement.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-1.5 border-t border-slate-300 text-[9.5px]">
              ...
              <div>
                <p className="font-bold text-slate-900 uppercase tracking-wider text-[9px] mb-0.5">
                  FOR PHONE SHOP BIRKENHEAD
                </p>
                <p className="text-[8.5px] text-slate-600 mb-3">
                  Authorised transaction confirmation on behalf of {businessName}.
                </p>
                <div className="space-y-1">
                  <div className="flex justify-between border-b border-slate-400 pb-0.5">
            ...
            <div className="pt-1 border-t border-slate-200 text-center text-[8.5px] text-slate-500 font-medium leading-tight">
              ...
              <p className="pt-0.5">
                {businessName} • {businessAddress} • Tel: {businessPhone}{businessEmail && ` • ${businessEmail}`}
              </p>
            </div>
          </div>
        </div>
